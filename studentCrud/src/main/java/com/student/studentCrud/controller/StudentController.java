...
public class StudentController {
    ...
    public ResponseEntity<Student> saveStudent( @RequestBody Student student) {
        ...
        ResponseEntity<Student> response = ResponseEntity.ok(studentService.saveStudent(student));
    ...
    public ResponseEntity<Student> getStudent(@RequestParam int studentId) {
        ...
        ResponseEntity<Student> response = ResponseEntity.ok(studentService.findStudent(studentId));
    ...
    public ResponseEntity<List<Student>> getAll() {
        ...
        ResponseEntity<List<Student>> response = ResponseEntity.ok(studentService.findAll());
    ...
    public ResponseEntity<Student> findByPhoneNo(@PathVariable String studentPhoneNo) {
        ...
        ResponseEntity<Student> response = ResponseEntity.ok(studentService.findByPhoneNo(studentPhoneNo));
    ...
    public ResponseEntity<Student> updateStudent(@RequestBody  Student student) {
        ...
        ResponseEntity<Student> response = ResponseEntity.ok(studentService.updateStudent(student));
    ...
    public ResponseEntity<Student> updateStudentName(@RequestParam int studentId, @RequestParam String studentName) {
        ...
        ResponseEntity<Student> response = ResponseEntity.ok(studentService.updateStudentName(studentId, studentName));
    ...
    public ResponseEntity<Student> deleteStudent(@PathVariable int studentId) {
        ...
        ResponseEntity<Student> response = ResponseEntity.ok(studentService.deleteStudent(studentId));
